...
set_property PACKAGE_PIN T2 [get_ports {read_select[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {read_select[0]}]
set_property PACKAGE_PIN R3 [get_ports {read_select[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {read_select[1]}]
